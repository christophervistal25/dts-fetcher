...
async function fetchRecord() {
    const recordResponse = await axios('http://192.168.1.2:8000/services/api/documents/records.php');
    ...
    const historyResponse = await axios('http://192.168.1.2:8000/services/api/documents/history.php');
